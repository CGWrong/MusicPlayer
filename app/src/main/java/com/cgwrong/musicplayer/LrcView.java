...
public class LrcView extends TextView{
    ...
    protected void onDraw(Canvas canvas){
        ...
        notCurrentPaint.setTextSize(60);
        notCurrentPaint.setTypeface(Typeface.DEFAULT);

        try {
            setText("");
            canvas.drawText(mLrcList.get(index).getLrcContent(),width/2,height/2,currentPaint);
            ...
            for (int i=index-1;i>=0;i--){
                ...
                canvas.drawText(mLrcList.get(i).getLrcContent(),width/2,tempY,notCurrentPaint);
            }
            tempY=height/2;
            //画出之后的句子
